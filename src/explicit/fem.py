            ...
            if count > 0 and n < nodes:
                for b in range(materials_number):
                    ...
                    while count < dimensionless_position[b] and n < nodes - 1:
                        ...
                        uj01 = uj0[n + 1]
                        uj0i_1 = uj0[n - 1]
                        materials_summary[b].central(
                            dt, square_velocity, dx, uj0i, uj01, uj0i_1, v0
                        )
                        ...
                        # Interface
                        if (
                            count > dimensionless_position[b]
                            and count < dimensionless_position[b] + dx
                        ):
                            # variables
                            ...
                            materials_summary[b].trans_interface(
                                young_modulus_1,
                                young_modulus1,
                                uj01,
                                uj0i_1,
                ...
                for b in range(materials_number):
                    ...
                    while count < dimensionless_position[b] and n < nodes - 1:
                        if n < 2 or n < nodes - 1:
                            ...
                            materials_summary[b].central_future(
                                dt, dx, square_velocity, uj01, uj0i, uj0i_1, uj_1i
                            )
                        ...
                        if n > 1 and n < nodes - 2:
                            ...
                            materials_summary[b].five_point_stencil(
                                square_velocity,
                                dx,
                                dt,
                                uj02,
